...
export type Sbv2JobOperation = "dummy" | "dataset-ingest" | "dataset-prepare" | "training-run" | "model-merge" | "model-style-merge" | "model-rename" | "model-promote" | "model-evaluate";
